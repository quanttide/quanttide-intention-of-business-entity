...
平台产品交付的是容器——引擎、契约、记录；规则本身（准入门槛、评审标准、代金券规则、流程定义）由治理主体决定，产品只提供修改能力与变更记录。

为什么要这样分工：规则一旦写进代码，修订它就变成发一次版本，产品于是替规则的主人做主，已经交出去的决定权被悄悄收回。**代码归公司，规则归基地。**

由此两条推论：配置能力与变更记录是产品的第一职责；平台不假设自己是某一个组织唯一的流程载体，允许流程定义外置。
